  ...
  <div class="relative bg-white rounded-sm shadow-xl dark:bg-gray-700">
    <div class="p-8 text-left">
      <div class="flex justify-between mb-10">
        <p class="py-1 text-2xl text-black">Pridėkite naują įmonę:</p>
      ...
      <div class="flex justify-start my-3">
        <button
          ...
          type="button"
          @click="addItem()"
          class="my -2 py-1 px-16 text-white text-sm bg-blue-800 hover:bg-blue-700 focus:outline-none dark:focus:ring-red-800 font-medium rounded-sm text-sm inline-flex items-centertext-center me-2"
        >
          Pridėti
        </button>
        <button
