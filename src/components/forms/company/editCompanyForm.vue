  ...
  <div class="relative bg-white rounded-sm shadow-xl dark:bg-gray-700">
    <div class="p-8 text-left">
      <div class="flex justify-between mb-10">
        <p class="py-1 text-2xl text-black">Redaguoti įmonę:</p>
      ...
      <p class="text-sm text-gray-800 dark:text-gray-400">Įmonės pavadinimas:</p>
      <input
      ...
      <div class="flex justify-start my-3">
        <button
          ...
          type="button"
          @click="addItem()"
          class="my -2 py-1 px-16 text-white text-sm bg-blue-800 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-sm text-sm inline-flex items-centertext-center me-2"
        >
          Redaguoti
        </button>
        <button
          ...
          type="button"
          @click="addItem()"
          class="my -2 py-1 px-16 text-white text-sm bg-gray-600 hover:bg-gray-700 focus:outline-none dark:focus:ring-red-800 font-medium rounded-sm text-sm inline-flex items-centertext-center me-2"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="red"
