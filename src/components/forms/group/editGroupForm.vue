  ...
  <div class="relative bg-white rounded-sm shadow-xl dark:bg-gray-700">
    <div class="p-8 text-left">
      <div class="flex justify-between mb-10">
        <p class="py-1 text-2xl text-black">Redaguoti grupę:</p>
        <button
      ...
      <div class="grid grid-cols-2 gap-8 py-8">
        <div class="grid grid-cols-1 gap-4">
          <div class="pb-4">
            <p class="text-sm text-gray-800 dark:text-gray-400">Grupės pavadinimas:</p>
            <input
              v-model="groupValue"
        ...
        <div>
          <div class="h-fit" v-for="(option, index) in departments">
            <input
              :id="'department' + index"
              type="checkbox"
              value=""
...
export default {
  ...
  data() {
    return {
      groupValue: "",
      departments: [{ name: "department1" }, { name: "department2" }],
    };
  },
  computed: {
